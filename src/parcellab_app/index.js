...
const siteURL = "https://parcellab-cdn.s3.eu-central-1.amazonaws.com/apps/kustomer/parcellab-widget.html?parcelLabApiToken={{settings.default.parcelLabApiToken}}";
...
export default {
    ...
    commands: Commands,
    kviews: [{
        "name": "parcellab_app.trackorders",
        "template": `<div>
        <DynamicCard
          src="${siteURL}"
          fillToWidth
        ...
        "meta": {
            "displayName": "parcelLab Order Tracking",
